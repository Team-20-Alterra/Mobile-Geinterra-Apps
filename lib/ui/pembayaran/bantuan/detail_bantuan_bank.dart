...
class BantuanBank extends StatefulWidget {
  const BantuanBank({super.key});

  @override
  State<BantuanBank> createState() => _BantuanBankState();
}

class _BantuanBankState extends State<BantuanBank> {
  @override
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Bagaimana Cara Membayar Tagihan melalui Rekening Bank?',
                          style: semibold16pt.copyWith(color: textBlack),
                        ),
                        SizedBox(
                          height: 8.0,
